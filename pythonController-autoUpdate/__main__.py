...
gamemenu.add_command(label="game_socket-client_2P-GUIv2.2",command=ctrl_s_cli_2)
gamemenu.add_command(label="game_socket-server_2P-GUIv2.2",command=ctrl_s_ser_2)
