class cheakFile:
    ...
    def _setup(self,from_file_path : str,correspond_file_path : str) -> bool:
        import os
        #import time
    ...
    def __init__(self,from_file_path : str,correspond_file_path : str,mode : str = "file"):
        """
        mode => "file" & "path" .
...
class cleanFile:
    ...
    def __init__(self,file_source = "temp/update-data-main/"):
        import os
        if file_source == "temp/update-data-main/":
...
class replaceFile:
    ...
    def __init__(self,file_source:str = "temp/update-data-main/",file_destination:str = "./",show_windows:bool = True,args:str = arg):
        """
...
class packageFile:
    ...
    def package(self,fileName,icon = "unicorn.ico",version = "0.0.0"):
        ...
        if not s:
            ...
            replaceFile("dist/",self.file_destination,self.show_windows,file_name+".exe")
    def main(self):
