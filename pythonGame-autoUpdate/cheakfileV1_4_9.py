...
class packageFile(cheakFile):
    ...
    def __init__(self,file_source = "temp/update-data-main/pythonGame-autoUpdate/",file_destination = "./",version = "0.0.0"):
        self.file_source = file_source
        self.file_destination = file_destination
    ...
    def package(self,fileName,icon = "unicorn",version = "0.0.0"):
        ...
        replaceFile(self.file_source,self.file_destination).replace_file(fileName+".exe")
    def main(self):
